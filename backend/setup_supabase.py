...
Usage: DATABASE_URL=postgresql://... python setup_supabase.py
"""
import os
import psycopg2
...
if not DATABASE_URL:
    raise RuntimeError("Set DATABASE_URL environment variable. Example: postgresql://postgres:PASSWORD@db.xxx.supabase.co:5432/postgres")
